...
class ReactModal extends Component {
    ...
    render() {
        ...
        const { product, image, text, arrayOption, count } = this.state;
            ...
            <div className="modal-container-small" >
                ...
                <div className="modal-product-detail-container">
                    <div className="modal-product-detail">
                        ...
                        <div className="modal-div-name">
                            <h3>{product.name}</h3>
                            <p>
                                Giá mặc định : {text}
                            </p>
                            <p>
                                {this.state.size ? this.state.size.name : null}
                            </p>
                    ...
                    <div className="modal-div-count-add">
                        ...
                        <div className="modal-div-add" onClick={() => this.addToCart()}>
                            <button className="">
                                thêm vào giỏ
                                    </button>
                            <span className="">
