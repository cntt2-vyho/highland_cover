        ...
        return (
            <div className="content-for-prddtl">
                <div className="content-container">
                    <div className="details col-lg-8 col-md-8 col-sm-12 col-12">
                        <div className="div-title-prddtl">
                            <h3 className="main-title-prddtl">Trà Sen Vàng</h3>
                        </div>
                        <div className="details-container">
                            <div className="details-img col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div className="details-content col-lg-6 col-md-6 col-sm-12 col-12">
                                <p>Thức uống chinh phục những thực khách khó tính! Sự kết hợp độc đáo giữa trà Ô long, hạt sen
            thơm bùi và củ năng giòn tan. Thêm vào chút sữa sẽ để vị thêm ngọt ngào.</p>
                    ...
                    <div className="checkout-overview col-lg-4 col-md-4 col-sm-12 col-12">
                        <div className="checkout-overview-container">
                            <div className="div-checkout-title">
                                <h3 className="checkout-title">checkout overview</h3>
                            </div>
                            <div className="checkout-detail">
                                <div className="scrollbar" id="style-3">
                                    <ul className="force-overflow" style={{ display: 'block' }}>
                                        <li className="checkout-li">
                                            <div className="checkout-div-img col-lg-3">
                                                <img src="https://www.highlandscoffee.com.vn/vnt_upload/product/03_2018/thumbs/270_crop_TRATHACHVAI.png" style={{ width: '100%' }} />
                                            </div>
                                            <div className="checkout-div-detail col-lg-6">
                                                <h4>TRÀ THẠCH VẢI</h4>
                                                <span>Size: S</span>
                                            </div>
                                            <div className="checkout-price col-lg-3">
                                                35.000 Đ </div>
                                        </li>
                                        <li className="checkout-li">
                                            <div className="checkout-div-img col-lg-3">
